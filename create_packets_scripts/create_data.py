...
for index in range(index_exploit, index_exploit + packet_num):
	print("Packet no. " + str(index))
	packet_file = folder_exploit + "/exploit" + str(index)
...
index_file_exploit.write(str(index_exploit + packet_num))
